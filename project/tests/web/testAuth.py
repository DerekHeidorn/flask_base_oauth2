...
class AuthTestCase(BaseTest):
    ...
    def xtestRegisteredWithAlreadyRegisteredUser(self):
    ...
    def xtestRegisteredUserLogin(self):
    ...
    def xtestNonRegisteredUserLogin(self):
    ...
    def xtestUserStatusMalformedBearerToken(self):
